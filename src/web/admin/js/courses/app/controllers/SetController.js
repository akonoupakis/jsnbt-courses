;(function () {
    ...
    var CoursesSetController = function ($scope, $rootScope, $q, $data, $jsnbt, $logger) {
    ...
    angular.module("jsnbt-courses")
        .controller('CoursesSetController', ['$scope', '$rootScope', '$q', '$data', '$jsnbt', '$logger', CoursesSetController]);
